...
MODEL_OUT = Path(
    "app/models/candidates/olympic_router_stage2_v2_temporal.joblib"
)
REPORT_OUT = Path(
    "ml/router_rebuild_v1/reports/olympic_router_stage2_v2_metrics.json"
)
PREDICTIONS_OUT = Path(
    "ml/router_rebuild_v1/reports/olympic_router_stage2_v2_predictions.csv"
)
...
bundle = {
    ...
    "random_state": RANDOM_STATE,
    "architecture": "stage_2_olympic_movement_router_v3_temporal",
}
