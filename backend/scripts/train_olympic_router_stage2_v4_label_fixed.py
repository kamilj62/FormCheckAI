...
DATA_PATH = Path(
    "ml/router_rebuild_v1/features/router_features_v3_label_fixed.csv"
)
MODEL_OUT = Path(
    "app/models/candidates/olympic_router_stage2_v4_label_fixed.joblib"
)
REPORT_OUT = Path(
    "ml/router_rebuild_v1/reports/olympic_router_stage2_v4_label_fixed_metrics.json"
)
PREDICTIONS_OUT = Path(
    "ml/router_rebuild_v1/reports/olympic_router_stage2_v4_label_fixed_predictions.csv"
)
...
bundle = {
    ...
    "random_state": RANDOM_STATE,
    "architecture": "stage_2_olympic_movement_router_v3_temporal_label_fixed",
}
