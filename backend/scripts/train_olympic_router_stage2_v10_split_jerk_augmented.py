...
MODEL_OUT = Path(
    "app/models/candidates/olympic_router_stage2_v10_split_jerk_augmented.joblib"
)
REPORT_OUT = Path(
    "ml/router_rebuild_v1/reports/olympic_router_stage2_v10_split_jerk_augmented_metrics.json"
)
PREDICTIONS_OUT = Path(
    "ml/router_rebuild_v1/reports/olympic_router_stage2_v10_split_jerk_augmented_predictions.csv"
)
...
bundle = {
    ...
    "random_state": RANDOM_STATE,
    "architecture": "stage_2_olympic_router_v10_grouped_cj",
}
