...
MODEL_OUT = Path(
    "app/models/candidates/olympic_router_stage2_v5_phase_order.joblib"
)
REPORT_OUT = Path(
    "ml/router_rebuild_v1/reports/olympic_router_stage2_v5_phase_order_metrics.json"
)
PREDICTIONS_OUT = Path(
    "ml/router_rebuild_v1/reports/olympic_router_stage2_v5_phase_order_predictions.csv"
)
...
bundle = {
    ...
    "random_state": RANDOM_STATE,
    "architecture": "stage_2_olympic_movement_router_v4_phase_order",
}
