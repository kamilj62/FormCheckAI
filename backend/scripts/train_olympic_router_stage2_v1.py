...
DATA_PATH = Path(
    "ml/router_rebuild_v1/features/router_features_v2_final.csv"
)
MODEL_OUT = Path(
    "app/models/candidates/olympic_router_stage2_v1_source_split.joblib"
)
REPORT_OUT = Path(
    "ml/router_rebuild_v1/reports/olympic_router_stage2_v1_metrics.json"
)
PREDICTIONS_OUT = Path(
    "ml/router_rebuild_v1/reports/olympic_router_stage2_v1_predictions.csv"
)
...
bundle = {
    ...
    "random_state": RANDOM_STATE,
    "architecture": "stage_2_olympic_movement_router",
}
