...
# Remove absolute video length to reduce source/edit-duration leakage.
FEATURE_NAMES = [
    name
...
DATA_PATH = Path(
    "ml/router_rebuild_v1/features/router_features_v4_label_fixed.csv"
)
MODEL_OUT = Path(
    "app/models/candidates/olympic_router_stage2_v6_robust_phase.joblib"
)
REPORT_OUT = Path(
    "ml/router_rebuild_v1/reports/olympic_router_stage2_v6_robust_phase_metrics.json"
)
PREDICTIONS_OUT = Path(
    "ml/router_rebuild_v1/reports/olympic_router_stage2_v6_robust_phase_predictions.csv"
)
...
bundle = {
    ...
    "random_state": RANDOM_STATE,
    "architecture": "stage_2_olympic_router_v6_robust_phase_no_frame_count",
}
