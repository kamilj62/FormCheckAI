...
DATA_PATH = Path(
    "ml/router_rebuild_v1/features/router_features_v3_gate_hardneg_v1.csv"
)
MODEL_OUT = Path(
    "app/models/candidates/olympic_gate_temporal_v1.joblib"
)
REPORT_OUT = Path(
    "ml/router_rebuild_v1/reports/olympic_gate_temporal_v1_metrics.json"
)
PREDICTIONS_OUT = Path(
    "ml/router_rebuild_v1/reports/olympic_gate_temporal_v1_predictions.csv"
)
