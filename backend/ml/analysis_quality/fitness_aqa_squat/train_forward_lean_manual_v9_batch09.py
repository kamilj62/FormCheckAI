...
TRAIN_PATH = (
    BASE / "forward_lean_manual_v9_batch09_train.jsonl"
)

VALIDATION_PATH = (
    BASE / "forward_lean_manual_v9_batch09_validation.jsonl"
)

MODEL_PATH = (
    BASE / "forward_lean_manual_v9_batch09_extratrees.joblib"
)

REPORT_PATH = (
    BASE / "forward_lean_manual_v9_batch09_report.json"
)
...
def main():
    ...
    report = {
        "version": "forward_lean_manual_v9_batch09_extratrees_v1",
        "status": "shadow_only",
