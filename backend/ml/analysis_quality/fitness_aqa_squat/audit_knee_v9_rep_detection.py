...
def main():
    ...
    data_path = BASE / f"knee_v5_{args.split}.jsonl"
    metadata_path = (
    ...
    output_path = (
        BASE
        / f"knee_v9_rep_audit_{args.split}.json"
    )

    output_path.write_text(
        json.dumps(
            {
                "version": "v9_rep_detection_audit",
                "split": args.split,
                "settings": {
